...
alias llt='ls -lhtFLr'
alias lx='ls -xXF'
alias lh="ls -lAXF|sed -n  '/ \..*$/p'"
alias lf="ls -l|grep ^-"
alias ld="ls -lF|grep ^d"
alias lhf="ls -lAXF|sed -n  '/ \..*$/p'|grep '^-'"
alias lhd="ls -lAXF|sed -n  '/ \..*$/p'|grep '^d'"
...
alias agd='sudo apt-get --yes dist-upgrade'
alias agi='sudo apt-get install'
alias agir='sudo apt-get --reinstall install'
alias agif='sudo apt-get -f install'
...
#¿¿.bashrc¿¿
alias szsh='. ~/.zshrc && echo "zsh updated."'
alias u='cd - && l'
alias h='cd && l'
alias ..='cd .. && l'
alias ...='cd ../.. && l'
...
#alias nginx='sudo /home/lvzhxznu/bin/nginx'
#alias phpfpm='/home/lvzhxznu/bin/php-fpm'

alias listcore='dpkg --get-selections|grep linux'
alias nowcore='uname -a'


alias network='sudo /etc/init.d/networking '

#需要安装memstat
alias mem='memstat -w | sort -rn '
...
#备份
function bak() { cp $1  $1-bak-`date +%y_%m_%d_%H:%M`; }

#删除某文件之外的文件
function rme() { ls | grep -v $1 | xargs rm -f ; }
function rmde() { ls | grep -v $1 | xargs rm -rf ; }
...
prom='%(?.$GREEN.$RED)`for ((i=1;i<$cols * 62/100;i++));do separator=$separator"%(?.-.x)";done;echo $separator`\n$YELLOW☆  $GREEN%* $RED %~ $FINISH| `ls -lAh|awk \047BEGIN{pos=0;a=0;b=0;c=0;d=0}{if(NR==1){pos=match($0,/[0-9]+/);total=substr($0,pos,length($ 0)-pos+1);}else{if(match($1,/^-/) && match($8,/^[^\.]/)) a++;if(match($1,/^d/) && match($8,/^[^\.]/)) b++;if( match($1,/^-/) && match($8,/^\./))  c++;if(match($1,/^d/) && match($8,/^\./))  d++;}}END {print a"%{\e[0;31m%}f " "%{\e[0m%}"b"%{\e[0;31m%}d ""%{\e[0m%}"c"%{\e[0;31m%}hf ""%{\e[0m%}"d "%{\e[0;31m%}hd ""%{\e[0m%}| ""%{\e[0;31m%}"total;}\047` %{\e[0m%}|$RED jobs %{\e[0m%}%j\n$GREEN>>$FINISH '
...
#目录颜色
LS_COLORS='rs=0:di=01;36:ln=36:hl=44;37:pi=40;33:so=01;35:do=01;35:bd=40;33;01:cd=40;33;01:or=40;31;01:su=37;41:sg=30;43:ca=30;41:tw=30;42:ow=34;42:st=37;44:ex=01;32:*.tar=01;31:*.tgz=01;31:*.arj=01;31:*.taz=01;31:*.lzh=01;31:*.lzma=01;31:*.zip=01;31:*.z=01;31:*.Z=01;31:*.dz=01;31:*.gz=01;31:*.bz2=01;31:*.bz=01;31:*.tbz2=01;31:*.tz=01;31:*.deb=01;31:*.rpm=01;31:*.jar=01;31:*.rar=01;31:*.ace=01;31:*.zoo=01;31:*.cpio=01;31:*.7z=01;31:*.rz=01;31:*.jpg=01;35:*.jpeg=01;35:*.gif=01;35:*.bmp=01;35:*.pbm=01;35:*.pgm=01;35:*.ppm=01;35:*.tga=01;35:*.xbm=01;35:*.xpm=01;35:*.tif=01;35:*.tiff=01;35:*.png=01;35:*.svg=01;35:*.svgz=01;35:*.mng=01;35:*.pcx=01;35:*.mov=01;35:*.mpg=01;35:*.mpeg=01;35:*.m2v=01;35:*.mkv=01;35:*.ogm=01;35:*.mp4=01;35:*.m4v=01;35:*.mp4v=01;35:*.vob=01;35:*.qt=01;35:*.nuv=01;35:*.wmv=01;35:*.asf=01;35:*.rm=01;35:*.rmvb=01;35:*.flc=01;35:*.avi=01;35:*.fli=01;35:*.flv=01;35:*.gl=01;35:*.dl=01;35:*.xcf=01;35:*.xwd=01;35:*.yuv=01;35:*.axv=01;35:*.anx=01;35:*.ogv=01;35:*.ogx=01;35:*.aac=00;36:*.au=00;36:*.flac=00;36:*.mid=00;36:*.midi=00;36:*.mka=00;36:*.mp3=00;36:*.mpc=00;36:*.ogg=00;36:*.ra=00;36:*.wav=00;36:*.axa=00;36:*.oga=00;36:*.spx=00;36:*.xspf=00;36:';
export LS_COLORS
...
alias svndif='svn diff '
alias svns='svn status '
alias svnr='svn revert '
alias svnlog='svn log '
alias svni='svn info '
alias svnlist='svn list '

alias hardware='sudo dmidecode '

alias gemi='sudo gem install '
alias gemu='sudo gem uninstall '
alias geml='sudo gem list '

alias slim='cl ~/site-src/slim/ '
alias scss='cl ~/site-src/scss/ '
alias jsr='cl ~/site-src/js/ '

alias html='cl ~/site/data_disk/ '
